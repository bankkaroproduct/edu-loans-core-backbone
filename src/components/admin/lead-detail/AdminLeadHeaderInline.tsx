// Inline header content rendered inside the AdminLayout top bar via HeaderSlotContext.
// Drops the standalone back button row and outer card chrome from the legacy
// AdminLeadHeader — back navigation is now owned by AdminLayout.
...
export function AdminLeadHeaderInline({ lead, submittedByName }: Props) {
