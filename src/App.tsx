      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/admin/settings" element={<AdminRoute><AdminPlaceholder title="Admin Settings" description="System-wide configuration, roles, and access management." /></AdminRoute>} />
